...
|LNA| is enabled by default. To use it, you can configure compatible devices in your database.
For example, a new checkbox labeled "Use Local Network Access" is available on the :doc:`printer form </applications/sales/point_of_sale/configuration/epos_printers>`.
