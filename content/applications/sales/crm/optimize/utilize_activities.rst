...
Next, in the :guilabel:`Summary` field, either leave this blank to use activity's Default Summary or
enter a new summary of what the activity entails. Entering a new summary does not overwrite an
