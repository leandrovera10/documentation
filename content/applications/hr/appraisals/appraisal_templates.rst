...
The default template appears in a list view, named :guilabel:`Default`. Click on the template to
view the template details. Make any desired changes to the template.
