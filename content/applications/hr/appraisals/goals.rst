...
The *Goals Library* houses all the goals configured in the database and where new goals are added.
To view all the currently configured goals, navigate to :menuselection:`Appraisals app -->
...
.. example::
   ...
   falls underneath the more comprehensive `Heavy Machinery Safety Training`.
...
.. example::
   ...
   instructions for who to contact to schedule the necessary training.

   .. image:: goals/goals-description.png
      :alt: The factory safety course with a list of the steps, and a ocntact for scheduling.
